...
function App() {
  return (
    <div className="!bg-black transition-all transform bg-[url('./assets/grbg.jg')]  select-none font-semibold bg-cover bg-no-repeat bg-center min-h-screen !text-slate-600 !text-opacity-75">
