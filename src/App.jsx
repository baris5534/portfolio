...
function App() {
  return (
    <div className="w-screen min-h-screen overflow-x-hidden bg-black font-rockwell">
      <header className="w-full max-w-[100vw] relative !bg-black transition-all transform select-none !text-white !text-opacity-75">
        <nav>
          <Router>
            <Routes>
      ...
      <main className="container backdrop-blur-xl bg-white/0 min-h-screen mx-auto flex flex-col items-start justify-center">
        ...
        <section className="w-full py-5 border-b-2 border-black">
          <Frameworks/>
        </section>
