    ...
    <div className="w-screen min-h-screen overflow-x-hidden bg-black font-rockwell relative">
      ...
      <div className="relative z-10">
        <main className="container bg-white/0 min-h-screen mx-auto flex flex-col items-start justify-center">
          <section className="flex flex-col max-xl:flex-col lg:flex-col lg:h-[900px] max-2xl:h-[700px] max-sm:w-full xl:h-screen items-center justify-around h-screen max-sm:h-scree max-xl:h-[750px] w-full py-10 px-10" >
            <Profileimg/>
