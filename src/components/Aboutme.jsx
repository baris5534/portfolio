...
function Aboutme (){
  //const [isHover, setHover] = useState(false);
    ...
    return(
        <div>
             {/* isim - bilgi */}
             <div className="flex flex-col space-y-2 capitalize *:text-style">
              <h2 className="text-6xl ">Merhaba, Ben</h2>
              <h1 className="text-8xl text-left ">Barış Yıldız</h1>
              <h3 className="text-4xl text-left ">
              Ben <span className="text-white">Frontend Developer'ım</span> 
              </h3>
              <h4 className="">
                "Ben lise hayatımdan itibaren Web arayüzüne merak sardım ve öğrenmeye başladım. kariyerimi frontend alanında geliştirmeye merak sardım ve işimi mutluluk ile yapıyorum. yeni teknolojileri
                takip ederim ."
              </h4>
            </div>
            {/* Linkler */}
            <div className="flex w-auto *:cursor-pointer items-center space-x-3 p-2 text-white">
              {/* github */}
              <div>
                <a
                  href="https://github.com/baris5534"
                  target="_blank"
              ...
              <div>
                <a
                  href="https://www.linkedin.com/in/bariş-yildiz-b36b97231"
                  target="_blank"
                  className="flex py-2 rounded-full"
                >
                  <span>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
              ...
              <div>
                <a
                  href="mailto:samsuncrsmb55@gmail.com"
                  target="_blank"
                  className="flex py-2 rounded-full"
                >
                  <span>
...
{/* geçmişim 
            <div className="w-full">
              <span>
                Merhaba Ben Barış Yıldız 2006 Samsun Doğumluyum. Balıkesir On
                Yedi Eylül Üniversitesi Bilgisayar Programcılığı Mezunuyum.
                Kendimi Front-End Alanında Geliştiriyorum.
              </span>
            </div>*/}